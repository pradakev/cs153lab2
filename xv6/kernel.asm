...
80103538:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010353b:	c7 40 14 d5 53 10 80 	movl   $0x801053d5,0x14(%eax)
...
80103555:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103558:	e8 43 0d 00 00       	call   801042a0 <memset>
...
80103577:	e8 d4 0c 00 00       	call   80104250 <release>
}
...
801069db:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
