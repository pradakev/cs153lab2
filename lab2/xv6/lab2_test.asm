...
int main(int argc, char *argv[])
{
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
    PScheduler();
   6:	e8 05 00 00 00       	call   10 <PScheduler>
...
int PScheduler(void){
  ...
  8f:	75 70                	jne    101 <PScheduler+0xf1>
            printf(1, " - Hello! this is child# %d and I will change my priority to %d \n", getpid(), 30 - 10 * i);
  91:	e8 2c 03 00 00       	call   3c2 <getpid>
  96:	6b db f6             	imul   $0xfffffff6,%ebx,%ebx
  99:	c7 44 24 04 f8 08 00 	movl   $0x8f8,0x4(%esp)
  a0:	00 
  a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  a8:	83 c3 1e             	add    $0x1e,%ebx
  ab:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  af:	89 44 24 08          	mov    %eax,0x8(%esp)
  b3:	e8 d8 03 00 00       	call   490 <printf>
            setpriority(30 - 10 * i); // Use your own setpriority interface
  b8:	89 1c 24             	mov    %ebx,(%esp)
  bb:	e8 22 03 00 00       	call   3e2 <setpriority>
  c0:	ba 50 c3 00 00       	mov    $0xc350,%edx
  c5:	8d 76 00             	lea    0x0(%esi),%esi
                asm("nop");
  c8:	90                   	nop
  c9:	b8 10 27 00 00       	mov    $0x2710,%eax
  ce:	66 90                	xchg   %ax,%ax
                    asm("nop"); 
  d0:	90                   	nop
                for(k = 0; k < 10000; k++) {
  d1:	83 e8 01             	sub    $0x1,%eax
  d4:	75 fa                	jne    d0 <PScheduler+0xc0>
            for (j = 0; j < 50000; j++) {
  d6:	83 ea 01             	sub    $0x1,%edx
  d9:	75 ed                	jne    c8 <PScheduler+0xb8>
            printf(1, " - Child #%d with priority %d has finished! \n", getpid(), 30-10*i);		
  db:	e8 e2 02 00 00       	call   3c2 <getpid>
  e0:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  e4:	c7 44 24 04 3c 09 00 	movl   $0x93c,0x4(%esp)
  eb:	00 
  ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f3:	89 44 24 08          	mov    %eax,0x8(%esp)
  f7:	e8 94 03 00 00       	call   490 <printf>
            exit();
  fc:	e8 41 02 00 00       	call   342 <exit>
            printf(2," \n Error fork() \n");
 101:	c7 44 24 04 6c 09 00 	movl   $0x96c,0x4(%esp)
 108:	00 
 109:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 110:	e8 7b 03 00 00       	call   490 <printf>
            exit();
 115:	e8 28 02 00 00       	call   342 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 429:	0f b6 92 85 09 00 00 	movzbl 0x985(%edx),%edx
  }while((x /= base) != 0);
 ...
 49e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 5bf:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5c1:	b8 7e 09 00 00       	mov    $0x97e,%eax
...
free(void *ap)
{
 ...
 681:	a1 24 0c 00 00       	mov    0xc24,%eax
{
 ...
 6c7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6c9:	a3 24 0c 00 00       	mov    %eax,0xc24
}
 6ce:	5b                   	pop    %ebx
 6cf:	5e                   	pop    %esi
 6d0:	5f                   	pop    %edi
 ...
 6ef:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 6f2:	a3 24 0c 00 00       	mov    %eax,0xc24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 1d 24 0c 00 00    	mov    0xc24,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 75b:	3b 15 24 0c 00 00    	cmp    0xc24,%edx
 ...
 78d:	e8 ee fe ff ff       	call   680 <free>
  return freep;
 792:	8b 15 24 0c 00 00    	mov    0xc24,%edx
 ...
 7b4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7b7:	89 15 24 0c 00 00    	mov    %edx,0xc24
      return (void*)(p + 1);
 ...
 7cc:	eb e9                	jmp    7b7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 7ce:	c7 05 24 0c 00 00 28 	movl   $0xc28,0xc24
 7d5:	0c 00 00 
    base.s.size = 0;
 7d8:	ba 28 0c 00 00       	mov    $0xc28,%edx
    base.s.ptr = freep = prevp = &base;
 7dd:	c7 05 28 0c 00 00 28 	movl   $0xc28,0xc28
 7e4:	0c 00 00 
    base.s.size = 0;
 7e7:	c7 05 2c 0c 00 00 00 	movl   $0x0,0xc2c
 7ee:	00 00 00 
