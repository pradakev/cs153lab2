...
80103502:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->prior_val = 0;    // Kevin Prada - Initializing Priority Value to 31
80103509:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
  p->pid = nextpid++;
...
80103538:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010353b:	c7 40 14 2f 54 10 80 	movl   $0x8010542f,0x14(%eax)
...
80103727:	e8 94 0b 00 00       	call   801042c0 <memset>
...
8010378e:	e8 0d 0d 00 00       	call   801044a0 <safestrcpy>
  p->cwd = namei("/");
...
801038a7:	8b 43 7c             	mov    0x7c(%ebx),%eax
801038aa:	89 42 7c             	mov    %eax,0x7c(%edx)
  np->tf->eax = 0;
801038ad:	8b 42 18             	mov    0x18(%edx),%eax
801038b0:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
801038b7:	90                   	nop
    if(curproc->ofile[i])
...
80103988:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
8010398d:	e8 6e 08 00 00       	call   80104200 <acquire>
...
801039cb:	e8 2b 0b 00 00       	call   801044fb <swtch>
      switchkvm();
...
801039ef:	e8 7c 08 00 00       	call   80104270 <release>
  }
...
80103a14:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a16:	e8 a5 07 00 00       	call   801041c0 <holding>
...
80103a57:	e8 9f 0a 00 00       	call   801044fb <swtch>
  mycpu()->intena = intena;
...
80103b03:	e8 f8 06 00 00       	call   80104200 <acquire>
...
80103bcd:	e8 2e 06 00 00       	call   80104200 <acquire>
...
80103bea:	e8 81 06 00 00       	call   80104270 <release>
}
80103bef:	c9                   	leave  
80103bf0:	c3                   	ret    
...
80103c31:	e8 ca 05 00 00       	call   80104200 <acquire>
    release(lk);
80103c36:	89 34 24             	mov    %esi,(%esp)
80103c39:	e8 32 06 00 00       	call   80104270 <release>
  p->chan = chan;
...
80103c5b:	e8 10 06 00 00       	call   80104270 <release>
    acquire(lk);
...
80103c69:	5d                   	pop    %ebp
    acquire(lk);
80103c6a:	e9 91 05 00 00       	jmp    80104200 <acquire>
80103c6f:	90                   	nop
  p->chan = chan;
...
80103cc4:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103cc6:	e8 35 05 00 00       	call   80104200 <acquire>
    havekids = 0;
...
80103d5d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103d64:	e8 07 05 00 00       	call   80104270 <release>
}
...
80103d79:	e8 f2 04 00 00       	call   80104270 <release>
}
...
80103da1:	e8 5a 04 00 00       	call   80104200 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103de3:	5d                   	pop    %ebp
  release(&ptable.lock);
80103de4:	e9 87 04 00 00       	jmp    80104270 <release>
...
80103e01:	e8 fa 03 00 00       	call   80104200 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e33:	e8 38 04 00 00       	call   80104270 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103e57:	e8 14 04 00 00       	call   80104270 <release>
}
...
80103efc:	e8 af 01 00 00       	call   801040b0 <getcallerpcs>
...
80103f43:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80103f46:	e8 55 f7 ff ff       	call   801036a0 <myproc>
  curproc->prior_val = prior_val;
80103f4b:	8b 55 08             	mov    0x8(%ebp),%edx
80103f4e:	89 50 7c             	mov    %edx,0x7c(%eax)
  yield();
80103f51:	e8 6a fc ff ff       	call   80103bc0 <yield>
  
  return 1;
}
80103f56:	b8 01 00 00 00       	mov    $0x1,%eax
80103f5b:	c9                   	leave  
80103f5c:	c3                   	ret    
...
80104026:	e8 65 fd ff ff       	call   80103d90 <wakeup>
  release(&lk->lk);
...
80105274:	e8 37 f3 ff ff       	call   801045b0 <argint>
...
801052c5:	e8 e6 f2 ff ff       	call   801045b0 <argint>
...
80105373:	e8 f8 ee ff ff       	call   80104270 <release>
      return -1;
...
8010538f:	e8 dc ee ff ff       	call   80104270 <release>
}
...
801053f4:	e8 b7 f1 ff ff       	call   801045b0 <argint>
801053f9:	85 c0                	test   %eax,%eax
801053fb:	78 13                	js     80105410 <sys_setpriority+0x30>
    return -1;
  return setpriority(prior_val);
801053fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105400:	89 04 24             	mov    %eax,(%esp)
80105403:	e8 38 eb ff ff       	call   80103f40 <setpriority>
...
80105418:	06                   	push   %es
  pushl %fs
80105419:	0f a0                	push   %fs
  pushl %gs
8010541b:	0f a8                	push   %gs
  pushal
8010541d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010541e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105422:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105424:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105426:	54                   	push   %esp
  call trap
80105427:	e8 e4 00 00 00       	call   80105510 <trap>
  addl $4, %esp
...
8010542f:	61                   	popa   
  popl %gs
80105430:	0f a9                	pop    %gs
  popl %fs
80105432:	0f a1                	pop    %fs
  popl %es
80105434:	07                   	pop    %es
  popl %ds
80105435:	1f                   	pop    %ds
...
801058b6:	6a 00                	push   $0x0
  jmp alltraps
801058b8:	e9 5a fb ff ff       	jmp    80105417 <alltraps>
...
801058bf:	6a 01                	push   $0x1
  jmp alltraps
801058c1:	e9 51 fb ff ff       	jmp    80105417 <alltraps>
...
801058c8:	6a 02                	push   $0x2
  jmp alltraps
801058ca:	e9 48 fb ff ff       	jmp    80105417 <alltraps>
...
801058d1:	6a 03                	push   $0x3
  jmp alltraps
801058d3:	e9 3f fb ff ff       	jmp    80105417 <alltraps>
...
801058da:	6a 04                	push   $0x4
  jmp alltraps
801058dc:	e9 36 fb ff ff       	jmp    80105417 <alltraps>
...
801058e3:	6a 05                	push   $0x5
  jmp alltraps
801058e5:	e9 2d fb ff ff       	jmp    80105417 <alltraps>
...
801058ec:	6a 06                	push   $0x6
  jmp alltraps
801058ee:	e9 24 fb ff ff       	jmp    80105417 <alltraps>
...
801058f5:	6a 07                	push   $0x7
  jmp alltraps
801058f7:	e9 1b fb ff ff       	jmp    80105417 <alltraps>
...
801058fc:	6a 08                	push   $0x8
  jmp alltraps
801058fe:	e9 14 fb ff ff       	jmp    80105417 <alltraps>
...
80105905:	6a 09                	push   $0x9
  jmp alltraps
80105907:	e9 0b fb ff ff       	jmp    80105417 <alltraps>
...
8010590c:	6a 0a                	push   $0xa
  jmp alltraps
8010590e:	e9 04 fb ff ff       	jmp    80105417 <alltraps>
...
80105913:	6a 0b                	push   $0xb
  jmp alltraps
80105915:	e9 fd fa ff ff       	jmp    80105417 <alltraps>
...
8010591a:	6a 0c                	push   $0xc
  jmp alltraps
8010591c:	e9 f6 fa ff ff       	jmp    80105417 <alltraps>
...
80105921:	6a 0d                	push   $0xd
  jmp alltraps
80105923:	e9 ef fa ff ff       	jmp    80105417 <alltraps>
...
80105928:	6a 0e                	push   $0xe
  jmp alltraps
8010592a:	e9 e8 fa ff ff       	jmp    80105417 <alltraps>
...
80105931:	6a 0f                	push   $0xf
  jmp alltraps
80105933:	e9 df fa ff ff       	jmp    80105417 <alltraps>
...
8010593a:	6a 10                	push   $0x10
  jmp alltraps
8010593c:	e9 d6 fa ff ff       	jmp    80105417 <alltraps>
...
80105941:	6a 11                	push   $0x11
  jmp alltraps
80105943:	e9 cf fa ff ff       	jmp    80105417 <alltraps>
...
8010594a:	6a 12                	push   $0x12
  jmp alltraps
8010594c:	e9 c6 fa ff ff       	jmp    80105417 <alltraps>
...
80105953:	6a 13                	push   $0x13
  jmp alltraps
80105955:	e9 bd fa ff ff       	jmp    80105417 <alltraps>
...
8010595c:	6a 14                	push   $0x14
  jmp alltraps
8010595e:	e9 b4 fa ff ff       	jmp    80105417 <alltraps>
...
80105965:	6a 15                	push   $0x15
  jmp alltraps
80105967:	e9 ab fa ff ff       	jmp    80105417 <alltraps>
...
8010596e:	6a 16                	push   $0x16
  jmp alltraps
80105970:	e9 a2 fa ff ff       	jmp    80105417 <alltraps>
...
80105977:	6a 17                	push   $0x17
  jmp alltraps
80105979:	e9 99 fa ff ff       	jmp    80105417 <alltraps>
...
80105980:	6a 18                	push   $0x18
  jmp alltraps
80105982:	e9 90 fa ff ff       	jmp    80105417 <alltraps>
...
80105989:	6a 19                	push   $0x19
  jmp alltraps
8010598b:	e9 87 fa ff ff       	jmp    80105417 <alltraps>
...
80105992:	6a 1a                	push   $0x1a
  jmp alltraps
80105994:	e9 7e fa ff ff       	jmp    80105417 <alltraps>
...
8010599b:	6a 1b                	push   $0x1b
  jmp alltraps
8010599d:	e9 75 fa ff ff       	jmp    80105417 <alltraps>
...
801059a4:	6a 1c                	push   $0x1c
  jmp alltraps
801059a6:	e9 6c fa ff ff       	jmp    80105417 <alltraps>
...
801059ad:	6a 1d                	push   $0x1d
  jmp alltraps
801059af:	e9 63 fa ff ff       	jmp    80105417 <alltraps>
...
801059b6:	6a 1e                	push   $0x1e
  jmp alltraps
801059b8:	e9 5a fa ff ff       	jmp    80105417 <alltraps>
...
801059bf:	6a 1f                	push   $0x1f
  jmp alltraps
801059c1:	e9 51 fa ff ff       	jmp    80105417 <alltraps>
...
801059c8:	6a 20                	push   $0x20
  jmp alltraps
801059ca:	e9 48 fa ff ff       	jmp    80105417 <alltraps>
...
801059d1:	6a 21                	push   $0x21
  jmp alltraps
801059d3:	e9 3f fa ff ff       	jmp    80105417 <alltraps>
...
801059da:	6a 22                	push   $0x22
  jmp alltraps
801059dc:	e9 36 fa ff ff       	jmp    80105417 <alltraps>
...
801059e3:	6a 23                	push   $0x23
  jmp alltraps
801059e5:	e9 2d fa ff ff       	jmp    80105417 <alltraps>
...
801059ec:	6a 24                	push   $0x24
  jmp alltraps
801059ee:	e9 24 fa ff ff       	jmp    80105417 <alltraps>
...
801059f5:	6a 25                	push   $0x25
  jmp alltraps
801059f7:	e9 1b fa ff ff       	jmp    80105417 <alltraps>
...
801059fe:	6a 26                	push   $0x26
  jmp alltraps
80105a00:	e9 12 fa ff ff       	jmp    80105417 <alltraps>
...
80105a07:	6a 27                	push   $0x27
  jmp alltraps
80105a09:	e9 09 fa ff ff       	jmp    80105417 <alltraps>
...
80105a10:	6a 28                	push   $0x28
  jmp alltraps
80105a12:	e9 00 fa ff ff       	jmp    80105417 <alltraps>
...
80105a19:	6a 29                	push   $0x29
  jmp alltraps
80105a1b:	e9 f7 f9 ff ff       	jmp    80105417 <alltraps>
...
80105a22:	6a 2a                	push   $0x2a
  jmp alltraps
80105a24:	e9 ee f9 ff ff       	jmp    80105417 <alltraps>
...
80105a2b:	6a 2b                	push   $0x2b
  jmp alltraps
80105a2d:	e9 e5 f9 ff ff       	jmp    80105417 <alltraps>
...
80105a34:	6a 2c                	push   $0x2c
  jmp alltraps
80105a36:	e9 dc f9 ff ff       	jmp    80105417 <alltraps>
...
80105a3d:	6a 2d                	push   $0x2d
  jmp alltraps
80105a3f:	e9 d3 f9 ff ff       	jmp    80105417 <alltraps>
...
80105a46:	6a 2e                	push   $0x2e
  jmp alltraps
80105a48:	e9 ca f9 ff ff       	jmp    80105417 <alltraps>
...
80105a4f:	6a 2f                	push   $0x2f
  jmp alltraps
80105a51:	e9 c1 f9 ff ff       	jmp    80105417 <alltraps>
...
80105a58:	6a 30                	push   $0x30
  jmp alltraps
80105a5a:	e9 b8 f9 ff ff       	jmp    80105417 <alltraps>
...
80105a61:	6a 31                	push   $0x31
  jmp alltraps
80105a63:	e9 af f9 ff ff       	jmp    80105417 <alltraps>
...
80105a6a:	6a 32                	push   $0x32
  jmp alltraps
80105a6c:	e9 a6 f9 ff ff       	jmp    80105417 <alltraps>
...
80105a73:	6a 33                	push   $0x33
  jmp alltraps
80105a75:	e9 9d f9 ff ff       	jmp    80105417 <alltraps>
...
80105a7c:	6a 34                	push   $0x34
  jmp alltraps
80105a7e:	e9 94 f9 ff ff       	jmp    80105417 <alltraps>
...
80105a85:	6a 35                	push   $0x35
  jmp alltraps
80105a87:	e9 8b f9 ff ff       	jmp    80105417 <alltraps>
...
80105a8e:	6a 36                	push   $0x36
  jmp alltraps
80105a90:	e9 82 f9 ff ff       	jmp    80105417 <alltraps>
...
80105a97:	6a 37                	push   $0x37
  jmp alltraps
80105a99:	e9 79 f9 ff ff       	jmp    80105417 <alltraps>
...
80105aa0:	6a 38                	push   $0x38
  jmp alltraps
80105aa2:	e9 70 f9 ff ff       	jmp    80105417 <alltraps>
...
80105aa9:	6a 39                	push   $0x39
  jmp alltraps
80105aab:	e9 67 f9 ff ff       	jmp    80105417 <alltraps>
...
80105ab2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ab4:	e9 5e f9 ff ff       	jmp    80105417 <alltraps>
...
80105abb:	6a 3b                	push   $0x3b
  jmp alltraps
80105abd:	e9 55 f9 ff ff       	jmp    80105417 <alltraps>
...
80105ac4:	6a 3c                	push   $0x3c
  jmp alltraps
80105ac6:	e9 4c f9 ff ff       	jmp    80105417 <alltraps>
...
80105acd:	6a 3d                	push   $0x3d
  jmp alltraps
80105acf:	e9 43 f9 ff ff       	jmp    80105417 <alltraps>
...
80105ad6:	6a 3e                	push   $0x3e
  jmp alltraps
80105ad8:	e9 3a f9 ff ff       	jmp    80105417 <alltraps>
...
80105adf:	6a 3f                	push   $0x3f
  jmp alltraps
80105ae1:	e9 31 f9 ff ff       	jmp    80105417 <alltraps>
...
80105ae8:	6a 40                	push   $0x40
  jmp alltraps
80105aea:	e9 28 f9 ff ff       	jmp    80105417 <alltraps>
...
80105af1:	6a 41                	push   $0x41
  jmp alltraps
80105af3:	e9 1f f9 ff ff       	jmp    80105417 <alltraps>
...
80105afa:	6a 42                	push   $0x42
  jmp alltraps
80105afc:	e9 16 f9 ff ff       	jmp    80105417 <alltraps>
...
80105b03:	6a 43                	push   $0x43
  jmp alltraps
80105b05:	e9 0d f9 ff ff       	jmp    80105417 <alltraps>
...
80105b0c:	6a 44                	push   $0x44
  jmp alltraps
80105b0e:	e9 04 f9 ff ff       	jmp    80105417 <alltraps>
...
80105b15:	6a 45                	push   $0x45
  jmp alltraps
80105b17:	e9 fb f8 ff ff       	jmp    80105417 <alltraps>
...
80105b1e:	6a 46                	push   $0x46
  jmp alltraps
80105b20:	e9 f2 f8 ff ff       	jmp    80105417 <alltraps>
...
80105b27:	6a 47                	push   $0x47
  jmp alltraps
80105b29:	e9 e9 f8 ff ff       	jmp    80105417 <alltraps>
...
80105b30:	6a 48                	push   $0x48
  jmp alltraps
80105b32:	e9 e0 f8 ff ff       	jmp    80105417 <alltraps>
...
80105b39:	6a 49                	push   $0x49
  jmp alltraps
80105b3b:	e9 d7 f8 ff ff       	jmp    80105417 <alltraps>
...
80105b42:	6a 4a                	push   $0x4a
  jmp alltraps
80105b44:	e9 ce f8 ff ff       	jmp    80105417 <alltraps>
...
80105b4b:	6a 4b                	push   $0x4b
  jmp alltraps
80105b4d:	e9 c5 f8 ff ff       	jmp    80105417 <alltraps>
...
80105b54:	6a 4c                	push   $0x4c
  jmp alltraps
80105b56:	e9 bc f8 ff ff       	jmp    80105417 <alltraps>
...
80105b5d:	6a 4d                	push   $0x4d
  jmp alltraps
80105b5f:	e9 b3 f8 ff ff       	jmp    80105417 <alltraps>
...
80105b66:	6a 4e                	push   $0x4e
  jmp alltraps
80105b68:	e9 aa f8 ff ff       	jmp    80105417 <alltraps>
...
80105b6f:	6a 4f                	push   $0x4f
  jmp alltraps
80105b71:	e9 a1 f8 ff ff       	jmp    80105417 <alltraps>
...
80105b78:	6a 50                	push   $0x50
  jmp alltraps
80105b7a:	e9 98 f8 ff ff       	jmp    80105417 <alltraps>
...
80105b81:	6a 51                	push   $0x51
  jmp alltraps
80105b83:	e9 8f f8 ff ff       	jmp    80105417 <alltraps>
...
80105b8a:	6a 52                	push   $0x52
  jmp alltraps
80105b8c:	e9 86 f8 ff ff       	jmp    80105417 <alltraps>
...
80105b93:	6a 53                	push   $0x53
  jmp alltraps
80105b95:	e9 7d f8 ff ff       	jmp    80105417 <alltraps>
...
80105b9c:	6a 54                	push   $0x54
  jmp alltraps
80105b9e:	e9 74 f8 ff ff       	jmp    80105417 <alltraps>
...
80105ba5:	6a 55                	push   $0x55
  jmp alltraps
80105ba7:	e9 6b f8 ff ff       	jmp    80105417 <alltraps>
...
80105bae:	6a 56                	push   $0x56
  jmp alltraps
80105bb0:	e9 62 f8 ff ff       	jmp    80105417 <alltraps>
...
80105bb7:	6a 57                	push   $0x57
  jmp alltraps
80105bb9:	e9 59 f8 ff ff       	jmp    80105417 <alltraps>
...
80105bc0:	6a 58                	push   $0x58
  jmp alltraps
80105bc2:	e9 50 f8 ff ff       	jmp    80105417 <alltraps>
...
80105bc9:	6a 59                	push   $0x59
  jmp alltraps
80105bcb:	e9 47 f8 ff ff       	jmp    80105417 <alltraps>
...
80105bd2:	6a 5a                	push   $0x5a
  jmp alltraps
80105bd4:	e9 3e f8 ff ff       	jmp    80105417 <alltraps>
...
80105bdb:	6a 5b                	push   $0x5b
  jmp alltraps
80105bdd:	e9 35 f8 ff ff       	jmp    80105417 <alltraps>
...
80105be4:	6a 5c                	push   $0x5c
  jmp alltraps
80105be6:	e9 2c f8 ff ff       	jmp    80105417 <alltraps>
...
80105bed:	6a 5d                	push   $0x5d
  jmp alltraps
80105bef:	e9 23 f8 ff ff       	jmp    80105417 <alltraps>
...
80105bf6:	6a 5e                	push   $0x5e
  jmp alltraps
80105bf8:	e9 1a f8 ff ff       	jmp    80105417 <alltraps>
...
80105bff:	6a 5f                	push   $0x5f
  jmp alltraps
80105c01:	e9 11 f8 ff ff       	jmp    80105417 <alltraps>
...
80105c08:	6a 60                	push   $0x60
  jmp alltraps
80105c0a:	e9 08 f8 ff ff       	jmp    80105417 <alltraps>
...
80105c11:	6a 61                	push   $0x61
  jmp alltraps
80105c13:	e9 ff f7 ff ff       	jmp    80105417 <alltraps>
...
80105c1a:	6a 62                	push   $0x62
  jmp alltraps
80105c1c:	e9 f6 f7 ff ff       	jmp    80105417 <alltraps>
...
80105c23:	6a 63                	push   $0x63
  jmp alltraps
80105c25:	e9 ed f7 ff ff       	jmp    80105417 <alltraps>
...
80105c2c:	6a 64                	push   $0x64
  jmp alltraps
80105c2e:	e9 e4 f7 ff ff       	jmp    80105417 <alltraps>
...
80105c35:	6a 65                	push   $0x65
  jmp alltraps
80105c37:	e9 db f7 ff ff       	jmp    80105417 <alltraps>
...
80105c3e:	6a 66                	push   $0x66
  jmp alltraps
80105c40:	e9 d2 f7 ff ff       	jmp    80105417 <alltraps>
...
80105c47:	6a 67                	push   $0x67
  jmp alltraps
80105c49:	e9 c9 f7 ff ff       	jmp    80105417 <alltraps>
...
80105c50:	6a 68                	push   $0x68
  jmp alltraps
80105c52:	e9 c0 f7 ff ff       	jmp    80105417 <alltraps>
...
80105c59:	6a 69                	push   $0x69
  jmp alltraps
80105c5b:	e9 b7 f7 ff ff       	jmp    80105417 <alltraps>
...
80105c62:	6a 6a                	push   $0x6a
  jmp alltraps
80105c64:	e9 ae f7 ff ff       	jmp    80105417 <alltraps>
...
80105c6b:	6a 6b                	push   $0x6b
  jmp alltraps
80105c6d:	e9 a5 f7 ff ff       	jmp    80105417 <alltraps>
...
80105c74:	6a 6c                	push   $0x6c
  jmp alltraps
80105c76:	e9 9c f7 ff ff       	jmp    80105417 <alltraps>
...
80105c7d:	6a 6d                	push   $0x6d
  jmp alltraps
80105c7f:	e9 93 f7 ff ff       	jmp    80105417 <alltraps>
...
80105c86:	6a 6e                	push   $0x6e
  jmp alltraps
80105c88:	e9 8a f7 ff ff       	jmp    80105417 <alltraps>
...
80105c8f:	6a 6f                	push   $0x6f
  jmp alltraps
80105c91:	e9 81 f7 ff ff       	jmp    80105417 <alltraps>
...
80105c98:	6a 70                	push   $0x70
  jmp alltraps
80105c9a:	e9 78 f7 ff ff       	jmp    80105417 <alltraps>
...
80105ca1:	6a 71                	push   $0x71
  jmp alltraps
80105ca3:	e9 6f f7 ff ff       	jmp    80105417 <alltraps>
...
80105caa:	6a 72                	push   $0x72
  jmp alltraps
80105cac:	e9 66 f7 ff ff       	jmp    80105417 <alltraps>
...
80105cb3:	6a 73                	push   $0x73
  jmp alltraps
80105cb5:	e9 5d f7 ff ff       	jmp    80105417 <alltraps>
...
80105cbc:	6a 74                	push   $0x74
  jmp alltraps
80105cbe:	e9 54 f7 ff ff       	jmp    80105417 <alltraps>
...
80105cc5:	6a 75                	push   $0x75
  jmp alltraps
80105cc7:	e9 4b f7 ff ff       	jmp    80105417 <alltraps>
...
80105cce:	6a 76                	push   $0x76
  jmp alltraps
80105cd0:	e9 42 f7 ff ff       	jmp    80105417 <alltraps>
...
80105cd7:	6a 77                	push   $0x77
  jmp alltraps
80105cd9:	e9 39 f7 ff ff       	jmp    80105417 <alltraps>
...
80105ce0:	6a 78                	push   $0x78
  jmp alltraps
80105ce2:	e9 30 f7 ff ff       	jmp    80105417 <alltraps>
...
80105ce9:	6a 79                	push   $0x79
  jmp alltraps
80105ceb:	e9 27 f7 ff ff       	jmp    80105417 <alltraps>
...
80105cf2:	6a 7a                	push   $0x7a
  jmp alltraps
80105cf4:	e9 1e f7 ff ff       	jmp    80105417 <alltraps>
...
80105cfb:	6a 7b                	push   $0x7b
  jmp alltraps
80105cfd:	e9 15 f7 ff ff       	jmp    80105417 <alltraps>
...
80105d04:	6a 7c                	push   $0x7c
  jmp alltraps
80105d06:	e9 0c f7 ff ff       	jmp    80105417 <alltraps>
...
80105d0d:	6a 7d                	push   $0x7d
  jmp alltraps
80105d0f:	e9 03 f7 ff ff       	jmp    80105417 <alltraps>
...
80105d16:	6a 7e                	push   $0x7e
  jmp alltraps
80105d18:	e9 fa f6 ff ff       	jmp    80105417 <alltraps>
...
80105d1f:	6a 7f                	push   $0x7f
  jmp alltraps
80105d21:	e9 f1 f6 ff ff       	jmp    80105417 <alltraps>
...
80105d28:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105d2d:	e9 e5 f6 ff ff       	jmp    80105417 <alltraps>
...
80105d34:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105d39:	e9 d9 f6 ff ff       	jmp    80105417 <alltraps>
...
80105d40:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105d45:	e9 cd f6 ff ff       	jmp    80105417 <alltraps>
...
80105d4c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105d51:	e9 c1 f6 ff ff       	jmp    80105417 <alltraps>
...
80105d58:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105d5d:	e9 b5 f6 ff ff       	jmp    80105417 <alltraps>
...
80105d64:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105d69:	e9 a9 f6 ff ff       	jmp    80105417 <alltraps>
...
80105d70:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105d75:	e9 9d f6 ff ff       	jmp    80105417 <alltraps>
...
80105d7c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105d81:	e9 91 f6 ff ff       	jmp    80105417 <alltraps>
...
80105d88:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105d8d:	e9 85 f6 ff ff       	jmp    80105417 <alltraps>
...
80105d94:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105d99:	e9 79 f6 ff ff       	jmp    80105417 <alltraps>
...
80105da0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105da5:	e9 6d f6 ff ff       	jmp    80105417 <alltraps>
...
80105dac:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105db1:	e9 61 f6 ff ff       	jmp    80105417 <alltraps>
...
80105db8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105dbd:	e9 55 f6 ff ff       	jmp    80105417 <alltraps>
...
80105dc4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105dc9:	e9 49 f6 ff ff       	jmp    80105417 <alltraps>
...
80105dd0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105dd5:	e9 3d f6 ff ff       	jmp    80105417 <alltraps>
...
80105ddc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105de1:	e9 31 f6 ff ff       	jmp    80105417 <alltraps>
...
80105de8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105ded:	e9 25 f6 ff ff       	jmp    80105417 <alltraps>
...
80105df4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105df9:	e9 19 f6 ff ff       	jmp    80105417 <alltraps>
...
80105e00:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105e05:	e9 0d f6 ff ff       	jmp    80105417 <alltraps>
...
80105e0c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105e11:	e9 01 f6 ff ff       	jmp    80105417 <alltraps>
...
80105e18:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105e1d:	e9 f5 f5 ff ff       	jmp    80105417 <alltraps>
...
80105e24:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105e29:	e9 e9 f5 ff ff       	jmp    80105417 <alltraps>
...
80105e30:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105e35:	e9 dd f5 ff ff       	jmp    80105417 <alltraps>
...
80105e3c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105e41:	e9 d1 f5 ff ff       	jmp    80105417 <alltraps>
...
80105e48:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105e4d:	e9 c5 f5 ff ff       	jmp    80105417 <alltraps>
...
80105e54:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105e59:	e9 b9 f5 ff ff       	jmp    80105417 <alltraps>
...
80105e60:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105e65:	e9 ad f5 ff ff       	jmp    80105417 <alltraps>
...
80105e6c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105e71:	e9 a1 f5 ff ff       	jmp    80105417 <alltraps>
...
80105e78:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105e7d:	e9 95 f5 ff ff       	jmp    80105417 <alltraps>
...
80105e84:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105e89:	e9 89 f5 ff ff       	jmp    80105417 <alltraps>
...
80105e90:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105e95:	e9 7d f5 ff ff       	jmp    80105417 <alltraps>
...
80105e9c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105ea1:	e9 71 f5 ff ff       	jmp    80105417 <alltraps>
...
80105ea8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105ead:	e9 65 f5 ff ff       	jmp    80105417 <alltraps>
...
80105eb4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105eb9:	e9 59 f5 ff ff       	jmp    80105417 <alltraps>
...
80105ec0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105ec5:	e9 4d f5 ff ff       	jmp    80105417 <alltraps>
...
80105ecc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105ed1:	e9 41 f5 ff ff       	jmp    80105417 <alltraps>
...
80105ed8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105edd:	e9 35 f5 ff ff       	jmp    80105417 <alltraps>
...
80105ee4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105ee9:	e9 29 f5 ff ff       	jmp    80105417 <alltraps>
...
80105ef0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105ef5:	e9 1d f5 ff ff       	jmp    80105417 <alltraps>
...
80105efc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105f01:	e9 11 f5 ff ff       	jmp    80105417 <alltraps>
...
80105f08:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105f0d:	e9 05 f5 ff ff       	jmp    80105417 <alltraps>
...
80105f14:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105f19:	e9 f9 f4 ff ff       	jmp    80105417 <alltraps>
...
80105f20:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105f25:	e9 ed f4 ff ff       	jmp    80105417 <alltraps>
...
80105f2c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105f31:	e9 e1 f4 ff ff       	jmp    80105417 <alltraps>
...
80105f38:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105f3d:	e9 d5 f4 ff ff       	jmp    80105417 <alltraps>
...
80105f44:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105f49:	e9 c9 f4 ff ff       	jmp    80105417 <alltraps>
...
80105f50:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105f55:	e9 bd f4 ff ff       	jmp    80105417 <alltraps>
...
80105f5c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105f61:	e9 b1 f4 ff ff       	jmp    80105417 <alltraps>
...
80105f68:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105f6d:	e9 a5 f4 ff ff       	jmp    80105417 <alltraps>
...
80105f74:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105f79:	e9 99 f4 ff ff       	jmp    80105417 <alltraps>
...
80105f80:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105f85:	e9 8d f4 ff ff       	jmp    80105417 <alltraps>
...
80105f8c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105f91:	e9 81 f4 ff ff       	jmp    80105417 <alltraps>
...
80105f98:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105f9d:	e9 75 f4 ff ff       	jmp    80105417 <alltraps>
...
80105fa4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105fa9:	e9 69 f4 ff ff       	jmp    80105417 <alltraps>
...
80105fb0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105fb5:	e9 5d f4 ff ff       	jmp    80105417 <alltraps>
...
80105fbc:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105fc1:	e9 51 f4 ff ff       	jmp    80105417 <alltraps>
...
80105fc8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105fcd:	e9 45 f4 ff ff       	jmp    80105417 <alltraps>
...
80105fd4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105fd9:	e9 39 f4 ff ff       	jmp    80105417 <alltraps>
...
80105fe0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105fe5:	e9 2d f4 ff ff       	jmp    80105417 <alltraps>
...
80105fec:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80105ff1:	e9 21 f4 ff ff       	jmp    80105417 <alltraps>
...
80105ff8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105ffd:	e9 15 f4 ff ff       	jmp    80105417 <alltraps>
...
80106004:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106009:	e9 09 f4 ff ff       	jmp    80105417 <alltraps>
...
80106010:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106015:	e9 fd f3 ff ff       	jmp    80105417 <alltraps>
...
8010601c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106021:	e9 f1 f3 ff ff       	jmp    80105417 <alltraps>
...
80106028:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010602d:	e9 e5 f3 ff ff       	jmp    80105417 <alltraps>
...
80106034:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106039:	e9 d9 f3 ff ff       	jmp    80105417 <alltraps>
...
80106040:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106045:	e9 cd f3 ff ff       	jmp    80105417 <alltraps>
...
8010604c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106051:	e9 c1 f3 ff ff       	jmp    80105417 <alltraps>
...
80106058:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010605d:	e9 b5 f3 ff ff       	jmp    80105417 <alltraps>
...
80106064:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106069:	e9 a9 f3 ff ff       	jmp    80105417 <alltraps>
...
80106070:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106075:	e9 9d f3 ff ff       	jmp    80105417 <alltraps>
...
8010607c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106081:	e9 91 f3 ff ff       	jmp    80105417 <alltraps>
...
80106088:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010608d:	e9 85 f3 ff ff       	jmp    80105417 <alltraps>
...
80106094:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106099:	e9 79 f3 ff ff       	jmp    80105417 <alltraps>
...
801060a0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801060a5:	e9 6d f3 ff ff       	jmp    80105417 <alltraps>
...
801060ac:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801060b1:	e9 61 f3 ff ff       	jmp    80105417 <alltraps>
...
801060b8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801060bd:	e9 55 f3 ff ff       	jmp    80105417 <alltraps>
...
801060c4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801060c9:	e9 49 f3 ff ff       	jmp    80105417 <alltraps>
...
801060d0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801060d5:	e9 3d f3 ff ff       	jmp    80105417 <alltraps>
...
801060dc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801060e1:	e9 31 f3 ff ff       	jmp    80105417 <alltraps>
...
801060e8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801060ed:	e9 25 f3 ff ff       	jmp    80105417 <alltraps>
...
801060f4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801060f9:	e9 19 f3 ff ff       	jmp    80105417 <alltraps>
...
80106100:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106105:	e9 0d f3 ff ff       	jmp    80105417 <alltraps>
...
8010610c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106111:	e9 01 f3 ff ff       	jmp    80105417 <alltraps>
...
80106118:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010611d:	e9 f5 f2 ff ff       	jmp    80105417 <alltraps>
...
80106124:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106129:	e9 e9 f2 ff ff       	jmp    80105417 <alltraps>
...
80106130:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106135:	e9 dd f2 ff ff       	jmp    80105417 <alltraps>
...
8010613c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106141:	e9 d1 f2 ff ff       	jmp    80105417 <alltraps>
...
80106148:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010614d:	e9 c5 f2 ff ff       	jmp    80105417 <alltraps>
...
80106154:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106159:	e9 b9 f2 ff ff       	jmp    80105417 <alltraps>
...
80106160:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106165:	e9 ad f2 ff ff       	jmp    80105417 <alltraps>
...
8010616c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106171:	e9 a1 f2 ff ff       	jmp    80105417 <alltraps>
...
80106178:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010617d:	e9 95 f2 ff ff       	jmp    80105417 <alltraps>
...
80106184:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106189:	e9 89 f2 ff ff       	jmp    80105417 <alltraps>
...
80106190:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106195:	e9 7d f2 ff ff       	jmp    80105417 <alltraps>
...
8010619c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801061a1:	e9 71 f2 ff ff       	jmp    80105417 <alltraps>
...
801061a8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801061ad:	e9 65 f2 ff ff       	jmp    80105417 <alltraps>
...
801061b4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801061b9:	e9 59 f2 ff ff       	jmp    80105417 <alltraps>
...
801061c0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801061c5:	e9 4d f2 ff ff       	jmp    80105417 <alltraps>
...
801061cc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801061d1:	e9 41 f2 ff ff       	jmp    80105417 <alltraps>
...
801061d8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801061dd:	e9 35 f2 ff ff       	jmp    80105417 <alltraps>
...
801061e4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801061e9:	e9 29 f2 ff ff       	jmp    80105417 <alltraps>
...
801061f0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801061f5:	e9 1d f2 ff ff       	jmp    80105417 <alltraps>
...
801061fc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106201:	e9 11 f2 ff ff       	jmp    80105417 <alltraps>
...
80106208:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010620d:	e9 05 f2 ff ff       	jmp    80105417 <alltraps>
...
80106214:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106219:	e9 f9 f1 ff ff       	jmp    80105417 <alltraps>
...
80106220:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106225:	e9 ed f1 ff ff       	jmp    80105417 <alltraps>
...
8010622c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106231:	e9 e1 f1 ff ff       	jmp    80105417 <alltraps>
...
80106238:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010623d:	e9 d5 f1 ff ff       	jmp    80105417 <alltraps>
...
80106244:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106249:	e9 c9 f1 ff ff       	jmp    80105417 <alltraps>
...
80106250:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106255:	e9 bd f1 ff ff       	jmp    80105417 <alltraps>
...
8010625c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106261:	e9 b1 f1 ff ff       	jmp    80105417 <alltraps>
...
80106268:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010626d:	e9 a5 f1 ff ff       	jmp    80105417 <alltraps>
...
80106274:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106279:	e9 99 f1 ff ff       	jmp    80105417 <alltraps>
...
80106280:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106285:	e9 8d f1 ff ff       	jmp    80105417 <alltraps>
...
8010628c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106291:	e9 81 f1 ff ff       	jmp    80105417 <alltraps>
...
80106298:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010629d:	e9 75 f1 ff ff       	jmp    80105417 <alltraps>
...
801062a4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801062a9:	e9 69 f1 ff ff       	jmp    80105417 <alltraps>
...
801062b0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801062b5:	e9 5d f1 ff ff       	jmp    80105417 <alltraps>
...
801062bc:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801062c1:	e9 51 f1 ff ff       	jmp    80105417 <alltraps>
...
801062c8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801062cd:	e9 45 f1 ff ff       	jmp    80105417 <alltraps>
...
801062d4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801062d9:	e9 39 f1 ff ff       	jmp    80105417 <alltraps>
...
801062e0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801062e5:	e9 2d f1 ff ff       	jmp    80105417 <alltraps>
...
801062ec:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801062f1:	e9 21 f1 ff ff       	jmp    80105417 <alltraps>
...
801062f8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801062fd:	e9 15 f1 ff ff       	jmp    80105417 <alltraps>
...
80106304:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106309:	e9 09 f1 ff ff       	jmp    80105417 <alltraps>
...
80106310:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106315:	e9 fd f0 ff ff       	jmp    80105417 <alltraps>
...
8010631c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106321:	e9 f1 f0 ff ff       	jmp    80105417 <alltraps>
